    ...
    public Result doLogin(AuthorizationUser user, HttpServletResponse response,HttpServletRequest request) {
        ...
        if (errorNum != null && errorNum > 2) {
            ...
            if (second > 0) {
                ...
                return Result.error(AuthorizationCodeEnum.AUTHORIZATION_LOGIN_PASSWORD_TO_MANY_ERROR, "Too many incorrect passwords, please visit "+errorTimeDesc+". Try again later!");
            }
        }
        try {
