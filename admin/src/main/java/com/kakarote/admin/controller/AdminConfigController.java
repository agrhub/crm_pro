...
public class AdminConfigController {
    ...
    @SysLogHandler(subModel = SubModelType.ADMIN_COMPANY_HOME,behavior = BehaviorEnum.UPDATE,object = "企业首页配置",detail = "'Enterprise homepage configuration:'+#adminCompanyBO.companyName")
    ...
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_OTHER_SETTINGS,behavior = BehaviorEnum.UPDATE,object = "活动咨询设置",detail = "Activity consultation setting")
    ...
    @SysLogHandler(subModel = SubModelType.ADMIN_OTHER_SETTINGS,behavior = BehaviorEnum.UPDATE,object = "设置日志欢迎语",detail = "Set log welcome message")
    ...
    public Result setMobileModuleSetting(@RequestBody JSONArray json) {
        ...
        if (userConfig != null) {
            ...
            userConfig.setDescription("Mobile phone module settings");
    ...
    public Result setActivityPhrase(@RequestBody List<String> stringList) {
        ...
        String description = "Common phrases for follow-up records";
    ...
    @SysLogHandler(subModel = SubModelType.ADMIN_OTHER_SETTINGS,behavior = BehaviorEnum.UPDATE,object = "设置跟进记录类型",detail = "Set follow-up record type")
