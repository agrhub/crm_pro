...
public class AdminUserController {
    ...
    @PostMapping("/addUser")
    @ApiOperation("新增用户")
    @SysLogHandler(behavior = BehaviorEnum.SAVE,object = "#adminUserVO.realname",detail = "'Added employees:'+#adminUserVO.realname")
    ...
    @SysLogHandler(behavior = BehaviorEnum.EXCEL_IMPORT,object = "excel导入员工",detail = "excel import employees")
    ...
    @ApiOperation("修改头像")
    @SysLogHandler(behavior = BehaviorEnum.UPDATE,object = "修改头像",detail = "Modify avatar")
    ...
    @ApiOperation("修改登录密码")
    @SysLogHandler(behavior = BehaviorEnum.UPDATE,object = "修改登录密码",detail = "Modify login password")
