...
public class CrmAchievementController {
    ...
    @ApiOperation("保存业绩目标")
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.UPDATE,object = "保存业绩目标",detail = "Save performance goals")
    ...
    @ApiOperation("修改业绩目标")
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.UPDATE,object = "修改业绩目标",detail = "Modify performance target")
    ...
    @ApiOperation("删除业绩目标")
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.DELETE,object = "删除业绩目标",detail = "Delete performance goal")
