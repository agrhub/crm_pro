        ...
        recordList.forEach(record -> {
            ...
            for (int i = 0; i < taskList.size(); i++) {
                ...
                if (i == 2) {
                    ...
                    JSONObject r = new JSONObject().fluentPut("name", "").fluentPut("month", "Quarter I").fluentPut("money", quarterMoney).fluentPut("achievement", quarterAchievement).fluentPut("rate", rate);
                    list.add(r.getInnerMap());
                    quarterMoney = new BigDecimal(0.00);
                    quarterAchievement = new BigDecimal(0.00);
                } else if (i == 5) {
                    BigDecimal rate = quarterMoney.divide(quarterAchievement, 4, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal(100));
                    JSONObject r = new JSONObject().fluentPut("name", "").fluentPut("month", "Quarter II").fluentPut("money", quarterMoney).fluentPut("achievement", quarterAchievement).fluentPut("rate", rate);
                    list.add(r.getInnerMap());
                    quarterMoney = new BigDecimal(0.00);
                    quarterAchievement = new BigDecimal(0.00);
                } else if (i == 8) {
                    BigDecimal rate = quarterMoney.divide(quarterAchievement, 4, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal(100));
                    JSONObject r = new JSONObject().fluentPut("name", "").fluentPut("month", "Quarter III").fluentPut("money", quarterMoney).fluentPut("achievement", quarterAchievement).fluentPut("rate", rate);
                    list.add(r.getInnerMap());
                    quarterMoney = new BigDecimal(0.00);
                    quarterAchievement = new BigDecimal(0.00);
                } else if (i == 11) {
                    BigDecimal rate = quarterMoney.divide(quarterAchievement, 4, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal(100));
                    JSONObject r = new JSONObject().fluentPut("name", "").fluentPut("month", "Quarter IV").fluentPut("money", quarterMoney).fluentPut("achievement", quarterAchievement).fluentPut("rate", rate);
                    list.add(r.getInnerMap());
                    quarterMoney = new BigDecimal(0.00);
                    quarterAchievement = new BigDecimal(0.00);
