...
public class CrmPrintTemplateController {
    ...
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.SAVE,object = "#adminPrintTemplate.templateName",detail = "'Added print template:'+#adminPrintTemplate.templateName")
