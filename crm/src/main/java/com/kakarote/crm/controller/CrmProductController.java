...
public class CrmProductController {
    ...
    @PostMapping("/add")
    @ApiOperation("保存数据")
    @SysLogHandler(behavior = BehaviorEnum.SAVE,object = "#crmModel.entity[name]",detail = "'New product: '+#crmModel.entity[name]")
    ...
    @ApiOperation("全部导出")
    @SysLogHandler(behavior = BehaviorEnum.EXCEL_EXPORT,object = "导出产品",detail = "Export all")
    ...
    @ApiOperation("选中导出")
    @SysLogHandler(behavior = BehaviorEnum.EXCEL_EXPORT,object = "导出产品",detail = "Select export")
    ...
    @ApiOperation("导入产品")
    @SysLogHandler(behavior = BehaviorEnum.EXCEL_IMPORT,object = "导入产品",detail = "Import products")
