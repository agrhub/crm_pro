...
public class CrmProductCategoryController {
    ...
    @PostMapping("/save")
    @ApiOperation("保存")
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.SAVE,object = "#productCategory.name",detail = "'Product category added:'+#productCategory.name")
    ...
    @PostMapping("/update")
    @ApiOperation("保存")
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.UPDATE,object = "#productCategory.name",detail = "'Modified product category:'+#productCategory.name")
