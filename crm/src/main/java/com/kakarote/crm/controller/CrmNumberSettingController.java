...
public class CrmNumberSettingController {
    ...
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.UPDATE,object = "修改编号规则设置",detail = "Modify number sequence settings")
