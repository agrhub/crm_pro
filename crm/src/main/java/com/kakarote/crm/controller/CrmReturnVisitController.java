...
public class CrmReturnVisitController {
    ...
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.UPDATE,object = "修改客户回访提醒设置",detail = "Modify customer return visit reminder settings")
