...
public class CrmBusinessTypeController {
    ...
    @ApiOperation("设置商机组")
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.UPDATE,object = "#jsonObject[crmBusinessType].name",detail = "'Set up business group:'+#jsonObject[crmBusinessType].name")
