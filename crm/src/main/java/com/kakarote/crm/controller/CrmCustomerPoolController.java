...
public class CrmCustomerPoolController {
    ...
    @SysLogHandler(applicationName = "admin",subModel = SubModelType.ADMIN_CUSTOMER_MANAGEMENT,behavior = BehaviorEnum.SAVE,object = "#jsonObject[poolName]",detail = "'High seas rules added or modified:'+#jsonObject[poolName]")
