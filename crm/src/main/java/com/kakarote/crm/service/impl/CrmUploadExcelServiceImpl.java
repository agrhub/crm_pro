                        ...
                        try {
                            ...
                            if (customerList.size() > 0) {
                                ...
                                if (getUploadExcelBO().getPoolId() != null) {
                                    ...
                                    if (count == 0) {
                                        rowList.add(0, "Duplicate data is not on the current high seas and has no right to overwrite");
                                        errorList.add(rowList);
                                        return;
                                    }
                                }
                            ...
                            log.error("Import data is abnormal:", ex);
                            ...
                            fixedFieldList.forEach(field -> {
                                if (!field.getFieldName().equals("categoryId")) {
                                    ...
                                    if (!"status".equals(fieldName)) {
                                        ...
                                        entityObject.fluentPut(fieldName, "on".equals(value) ? 1 : 0);
                                    }
