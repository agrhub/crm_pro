...
public class CrmContactsServiceImpl extends BaseServiceImpl<CrmContactsMapper, CrmContacts> implements ICrmContactsService, CrmPageService {
    ...
    public void downloadExcel(HttpServletResponse response) throws IOException {
        ...
        HSSFSheet sheet = wb.createSheet("Import contact form");
        ...
        titleRow.createCell(0).setCellValue("Import contact template (*) is required");
    ...
    public List<CrmModelFiledVO> information(Integer contactsId) {
        ...
        List<String> systemFieldList = Arrays.asList("createdBy", "createdTime", "updatedTime", "lastFollowupTime");
        ...
        crmModelFiledVOS.add(new CrmModelFiledVO("customerName", FieldEnum.CUSTOMER, "customerName", 1).setValue(object));
