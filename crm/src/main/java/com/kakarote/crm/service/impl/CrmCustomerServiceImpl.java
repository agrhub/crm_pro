...
public class CrmCustomerServiceImpl extends BaseServiceImpl<CrmCustomerMapper, CrmCustomer> implements ICrmCustomerService, CrmPageService {
    ...
    public List<CrmModelFiledVO> queryField(Integer id) {
        ...
        vos.add(new CrmModelFiledVO("map_address", FieldEnum.MAP_ADDRESS, "map_address", 1).setIsNull(0).setValue(value));
        return vos;
    }
    ...
    public void exportExcel(HttpServletResponse response, CrmSearchBO search) {
        ...
        try (ExcelWriter writer = ExcelUtil.getWriter()) {
            ...
            dataList.forEach(record -> {
                record.put("dealStatus", Objects.equals(1, record.get("dealStatus")) ? "dealdone" : "unsold");
    ...
    public List<CrmMembersSelectVO> getMembers(Integer customerId) {
        ...
        if (crmCustomer.getOwnerUserId() != null) {
            ...
            crmMembersVO.setPower("Manager");
            crmMembersVO.setGroupRole("Principal Member");
    ...
    public List<CrmModelFiledVO> information(Integer customerId, Integer poolId) {
        ...
        List<String> systemFieldList = Arrays.asList("last_follow-up_time", "creator", "created_time", "update_time", "last_follow-up_record", "transaction_status", "owner_user_name");
        ...
        filedVO.setName("deal_status");
        filedVO.setValue(Objects.equals(0, crmModel.get("dealStatus")) ? "unsold" : "dealdone");
        ...
        crmModelFiledVOS.add(new CrmModelFiledVO().setName("map_address").setFormType("map_address").setFieldType(1).setValue(map));
        ...
        if (ObjectUtil.isNotEmpty(poolId)) {
            ...
            collect.removeIf(r -> disjunction.contains(r.getName()) || nameList.contains(r.getName()) || "owner_user_name".equals(r.getName()) || "owner_user_name".equals(r.getName()));
        } else {
            collect.removeIf(r -> "owner_user_name".equals(r.getName()));
        }
