...
public class CrmReturnVisitServiceImpl extends BaseServiceImpl<CrmReturnVisitMapper, CrmReturnVisit> implements ICrmReturnVisitService, CrmPageService {
    ...
    public List<CrmModelFiledVO> information(Integer visitId) {
        ...
        crmModelFiledVOS.add(new CrmModelFiledVO().setFieldName("ownerUserId").setName("returnVisitor").setFieldType(1).setFormType("single_user").setValue(new JSONObject().fluentPut("userId", crmModel.get("userId")).fluentPut("realname", crmModel.get("ownerUserName"))));
        crmModelFiledVOS.add(new CrmModelFiledVO().setFieldName("customerId").setName("customerName").setFieldType(1).setFormType("customer").setValue(new JSONObject().fluentPut("customerId", crmModel.get("customerId")).fluentPut("customerName", crmModel.get("customerName"))));
        crmModelFiledVOS.add(new CrmModelFiledVO().setFieldName("contactsId").setName("contactName").setFieldType(1).setFormType("contacts").setValue(new JSONObject().fluentPut("contactsId", crmModel.get("contactsId")).fluentPut("contactsName", crmModel.get("contactsName"))));
        crmModelFiledVOS.add(new CrmModelFiledVO().setFieldName("contractId").setName("contractNo").setFieldType(1).setFormType("contract").setValue(new JSONObject().fluentPut("contractId", crmModel.get("contractId")).fluentPut("contractNum", crmModel.get("contractNum"))));
