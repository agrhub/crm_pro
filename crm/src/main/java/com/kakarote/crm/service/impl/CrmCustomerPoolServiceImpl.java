...
public class CrmCustomerPoolServiceImpl extends BaseServiceImpl<CrmCustomerPoolMapper, CrmCustomerPool> implements ICrmCustomerPoolService, CrmPageService {
    ...
    public List<CrmModelFiledVO> queryPoolField() {
        ...
        dealStatusList.add(new JSONObject().fluentPut("name", "dealdone").fluentPut("value", 1));
        fieldList.add(new CrmModelFiledVO("deal_status", FieldEnum.SELECT, "deal_status", 1).setSetting(dealStatusList).setFormType("dealStatus"));
        fieldList.add(new CrmModelFiledVO().setFieldName("lastTime").setName("lastTime").setType(13));
        fieldList.add(new CrmModelFiledVO().setFieldName("lastContent").setName("lastContent").setType(2));
        fieldList.add(new CrmModelFiledVO().setFieldName("updateTime").setName("updateTime").setType(13));
        fieldList.add(new CrmModelFiledVO().setFieldName("createTime").setName("createTime").setType(13));
        fieldList.add(new CrmModelFiledVO().setFieldName("createUserId").setName("createUserId").setType(10));
        fieldList.add(new CrmModelFiledVO().setFieldName("detailAddress").setName("detailAddress").setType(1));
        fieldList.add(new CrmModelFiledVO().setFieldName("address").setName("address").setType(18));
        fieldList.add(new CrmModelFiledVO().setFieldName("preOwnerUserId").setName("preOwnerUserId").setType(10));
        fieldList.add(new CrmModelFiledVO().setFieldName("poolTime").setName("poolTime").setType(13));
