...
public class CrmReceivablesServiceImpl extends BaseServiceImpl<CrmReceivablesMapper, CrmReceivables> implements ICrmReceivablesService, CrmPageService {
    ...
    public List<FileEntity> queryFileList(Integer id) {
        ...
        if (crmFields.size() > 0) {
            ...
            data.forEach(fileEntity -> {
                fileEntity.setSource("Payment details");
    ...
    public List<CrmModelFiledVO> information(Integer contractId) {
        ...
        List<String> systemFieldList = Arrays.asList("createdBy", "createdTime", "updatedTime");
        ...
        crmModelFiledVOS.add(new CrmModelFiledVO().setFieldName("contractId").setName("contractNo").setValue(new JSONObject().fluentPut("contractId", crmModel.get("contractId")).fluentPut("contractNum", crmModel.get("contractNum"))).setFormType("contract").setFieldType(1));
        crmModelFiledVOS.add(new CrmModelFiledVO().setFieldName("contractId").setName("contractTitle").setValue(new JSONObject().fluentPut("contractId", crmModel.get("contractId")).fluentPut("contractNum", crmModel.get("contractName"))).setFormType("contract").setFieldType(1));
        ...
        crmModelFiledVOS.add(new CrmModelFiledVO().setFieldName("planId").setName("periods").setValue(crmModel.get("planNum")).setFormType("planNum").setFieldType(FieldEnum.NUMBER.getType()));
