...
public class WorkTaskController {
    ...
    @ApiOperation("新建项目任务")
    @SysLogHandler(behavior = BehaviorEnum.SAVE,object = "#workTask.name",detail = "'New task:'+#workTask.name")
    ...
    @SysLogHandler(behavior = BehaviorEnum.EXCEL_EXPORT,object = "导出工作台任务",detail = "Export workbench tasks")
    public void workBenchTaskExport(HttpServletResponse response) {
        ...
        try {
            ...
            writer.addHeaderAlias("isTop", "tasks");
            ...
            log.error("Error in exporting workbench task information:", e);
        } finally {
            // 关闭writer，释放内存
            writer.close();
        }
