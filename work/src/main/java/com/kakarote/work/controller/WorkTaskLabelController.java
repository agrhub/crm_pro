...
public class WorkTaskLabelController {
    ...
    @ApiOperation("新建任务标签")
    @SysLogHandler(behavior = BehaviorEnum.SAVE,object = "#workTaskLabel.name",detail = "'New label:'+#workTaskLabel.name")
    ...
    @ApiOperation("编辑任务标签")
    @SysLogHandler(behavior = BehaviorEnum.UPDATE,object = "#workTaskLabel.name",detail = "'Modified label:'+#workTaskLabel.name")
