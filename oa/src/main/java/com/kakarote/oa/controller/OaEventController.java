...
public class OaEventController {
    ...
    @PostMapping("/update")
    @ApiOperation("修改日程")
    @SysLogHandler(behavior = BehaviorEnum.UPDATE,object = "#setEventBO.event.title",detail = "'Revised schedule:'+#setEventBO.event.title")
    ...
    @PostMapping("/delete")
    @ApiOperation("删除日程")
    @SysLogHandler(behavior = BehaviorEnum.DELETE,object = "",detail = "Agenda deleted")
