...
//        Aop.get(ActionRecordUtil.class).addExportActionRecord(CrmEnum.OA_EXAMINE, list.size());
        ...
        try {
            Integer columnNum = 1;
            writer.addHeaderAlias("category", "Approval type");
            writer.addHeaderAlias("createTime", "Creation date");
            writer.addHeaderAlias("createUserName", "Creator");
            writer.addHeaderAlias("examineStatus", "Status");
            writer.addHeaderAlias("examineUserName", "Approver");
//            writer.addHeaderAlias("previousExamineUserName", "上一审批人");
            switch (type) {
                case 1:
                    writer.addHeaderAlias("content", "Approval content");
                    writer.addHeaderAlias("remark", "Remarks");
                    columnNum = 8;
                    break;
                case 2:
                    writer.addHeaderAlias("content", "Approval content");
                    writer.addHeaderAlias("startTime", "Start time");
                    writer.addHeaderAlias("endTime", "End time");
                    writer.addHeaderAlias("duration", "Duration");
                    writer.addHeaderAlias("remark", "Remarks");
                    columnNum = 11;
                    break;
                case 3:
                    ...
                    writer.addHeaderAlias("remark", "Remarks");
                    writer.addHeaderAlias("duration", "Duration");
                    writer.addHeaderAlias("vehicle", "Vehicle");
                    writer.addHeaderAlias("trip", "One-way/Two-way");
                    writer.addHeaderAlias("startAddress", "Departure city");
                    writer.addHeaderAlias("endAddress", "Destination city");
                    writer.addHeaderAlias("startTime", "Start time");
                    writer.addHeaderAlias("endTime", "End time");
                    writer.addHeaderAlias("travelDuration", "Total Duration");
                    writer.addHeaderAlias("description", "Travel notes");
                    columnNum = 17;
                    break;
                case 4:
                    writer.addHeaderAlias("content", "Approval content");
                    writer.addHeaderAlias("startTime", "Start time");
                    writer.addHeaderAlias("endTime", "End time");
                    writer.addHeaderAlias("duration", "Total days of overtime");
                    writer.addHeaderAlias("remark", "Remarks");
                    columnNum = 11;
                    break;
                case 5:
                    writer.addHeaderAlias("content", "Approval content");
                    writer.addHeaderAlias("money", "Total amount of reimbursement");
                    writer.addHeaderAlias("remark", "Remarks");
                    writer.addHeaderAlias("startAddress", "Departure city");
                    writer.addHeaderAlias("endAddress", "Destination city");
                    writer.addHeaderAlias("startTime", "Start time");
                    writer.addHeaderAlias("endTme", "End time");
                    writer.addHeaderAlias("traffic", "Transportation");
                    writer.addHeaderAlias("stay", "Accommodation fee");
                    writer.addHeaderAlias("diet", "Dining fee");
                    writer.addHeaderAlias("other", "Other fee");
                    writer.addHeaderAlias("travelMoney", "Total");
                    writer.addHeaderAlias("description", "Expenses detailed description");
                    columnNum = 18;
                    break;
                case 6:
                    writer.addHeaderAlias("content", "Approval content");
                    writer.addHeaderAlias("money", "Loan amount");
                    writer.addHeaderAlias("remark", "Remarks");
                    columnNum = 9;
                    break;
                case 0:
            ...
            writer.merge(columnNum - 1, "Approval Information");
