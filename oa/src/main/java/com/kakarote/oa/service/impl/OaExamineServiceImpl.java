        ...
        if (count > 0) {
            ...
            switch (categoryTitle) {
                case "businessTripApproval":
                    ...
                    causeTitle.append("days");
                    break;
                case "travelReimbursement":
                    causeTitle.append("Reimbursement items, total ");
                    if (record.getMoney() != null) {
                        causeTitle.append(record.getMoney());
                    } else {
                        causeTitle.append(0);
                    }
                    causeTitle.append("đồng");
                    break;
                default:
                    break;
            }
...
//        OaExamineCategory oaExamineCategory = examineCategoryService.getById(categoryId);
        ...
        switch (oaType) {
            case 1:
                fieldUtil.oaFieldAdd("content", "approvalContent", "text", arr, 1, 0, oaExamineInfo.getContent(), "", 3, 1)
                        .oaFieldAdd("remark", "remark", "textarea", arr, 0, 0, oaExamineInfo.getRemark(), "", 3, 1);
                break;
            case 2:
                fieldUtil.oaFieldAdd("type_id", "typeId", "select", Lists.newArrayList("annual leave", "personal leave", "sick leave", "maternity leave", "adjustment leave", "marriage leave", "mourning leave", "others"), 1, 0, oaExamineInfo.getTypeId(), "", 3, 1)
                        .oaFieldAdd("content", "approvalContent", "text", arr, 1, 0, oaExamineInfo.getContent(), "", 3, 1)
                        .oaFieldAdd("start_time", "startTime", "datetime", arr, 1, 0, oaExamineInfo.getStartTime(), "", 3, 1)
                        .oaFieldAdd("end_time", "endTime", "datetime", arr, 1, 0, oaExamineInfo.getEndTime(), "", 3, 1)
                        .oaFieldAdd("duration", "duration", "floatnumber", arr, 1, 0, String.valueOf(oaExamineInfo.getDuration()), "", 3, 1)
                        .oaFieldAdd("remark", "remark", "textarea", arr, 0, 0, oaExamineInfo.getRemark(), "", 3, 1);
                break;
            case 3:
                fieldUtil.oaFieldAdd("content", "businessTrip", "text", arr, 1, 0, oaExamineInfo.getContent(), "", 3, 1)
                        .oaFieldAdd("remark", "remark", "textarea", arr, 0, 0, oaExamineInfo.getRemark(), "", 3, 1)
                        .oaFieldAdd("cause", "cause", "business_cause", arr, 1, 0, examineTravelList, "", 3, 1)
                        .oaFieldAdd("duration", "duration", "floatnumber", arr, 1, 0, String.valueOf(oaExamineInfo.getDuration()), "", 3, 1);
                break;
            case 4:
                fieldUtil.oaFieldAdd("content", "overtime", "text", arr, 1, 0, oaExamineInfo.getContent(), "", 3, 1)
                        .oaFieldAdd("start_time", "startTime", "datetime", arr, 1, 0, oaExamineInfo.getStartTime(), "", 3, 1)
                        .oaFieldAdd("end_time", "endTime", "datetime", arr, 1, 0, oaExamineInfo.getEndTime(), "", 3, 1)
                        .oaFieldAdd("duration", "duration", "floatnumber", arr, 1, 0, oaExamineInfo.getDuration(), "", 3, 1)
                        .oaFieldAdd("remark", "remark", "textarea", arr, 0, 0, oaExamineInfo.getRemark(), "", 3, 1);
                break;
            case 5:
                fieldUtil.oaFieldAdd("content", "travel", "text", arr, 1, 0, oaExamineInfo.getContent(), "", 3, 1)
                        .oaFieldAdd("cause", "cause", "examine_cause", arr, 1, 0, examineTravelList, "", 3, 1)
                        .oaFieldAdd("money", "money", "floatnumber", arr, 1, 0, String.valueOf(oaExamineInfo.getMoney()), "", 3, 1)
                        .oaFieldAdd("remark", "remark", "textarea", arr, 0, 0, oaExamineInfo.getRemark(), "", 3, 1);
                break;
            case 6:
                fieldUtil.oaFieldAdd("content", "loan", "text", arr, 1, 0, oaExamineInfo.getContent(), "", 3, 1)
                        .oaFieldAdd("money", "money", "floatnumber", arr, 1, 0, String.valueOf(oaExamineInfo.getMoney()), "", 3, 1)
                        .oaFieldAdd("remark", "remark", "textarea", arr, 0, 0, oaExamineInfo.getRemark(), "", 3, 1);
                break;
            default:
...
//            examineList = examineMapper.myOaExamineExcel(examineExportBO, userId, UserUtil.isAdmin());
        ...
        switch (type) {
            case 1:
                recordList.forEach(record -> {
                    record.put("category", "Ordinary approval");
            ...
            case 2:
                recordList.forEach(record -> {
                    record.put("category", "Leave approval-" + record.getString("typeId"));
                    putRelateCrmWork(record);
                    list.add(record.getInnerMap());
                });
                break;
            case 3:
                for (int i = 0; i < recordList.size(); i++) {
                    ...
                    if (i > 0 && record.getInteger("examineId").equals(recordList.get(i - 1).getInteger("examineId"))) {
                        ...
                        record.put("category", "Business trip approval");
                        putRelateCrmWork(record);
                    }
                    list.add(record.getInnerMap());
                }
            ...
            case 4:
                recordList.forEach(record -> {
                    record.put("category", "Overtime approval");
                    putRelateCrmWork(record);
                    list.add(record.getInnerMap());
                });
                break;
            case 5:
                for (int i = 0; i < recordList.size(); i++) {
                    ...
                    if (i > 0 && record.getInteger("examineId").equals(recordList.get(i - 1).getInteger("examineId"))) {
                        ...
                        record.fluentPut("category", "Travel reimbursement");
                        putRelateCrmWork(record);
                    }
                    list.add(record.getInnerMap());
                }
            ...
            case 6:
                recordList.forEach(record -> {
                    record.put("category", "Loan application");
                    putRelateCrmWork(record);
                    list.add(record.getInnerMap());
                });
                break;
    ...
    private void putRelateCrmWork(JSONObject record) {
        ...
        if (StrUtil.isNotEmpty(record.getString("contactsIds"))) {
            relateCrmWork = relateCrmWork + "contact name 【" + record.getString("contactsName") + "】\n";
        }
        if (StrUtil.isNotEmpty(record.getString("businessIds"))) {
            relateCrmWork = relateCrmWork + "business 【" + record.getString("businessName") + "】\n";
        }
        if (StrUtil.isNotEmpty(record.getString("contractIds"))) {
            relateCrmWork = relateCrmWork + "contract no 【" + record.getString("contractName") + "】\n";
        }
